...
public class NoteTextBox : MonoBehaviour
{
    ...
    public static NoteTextBox Instance;
    ...
    void Awake()
    {
        ...
        // 메시지 예시
        messages = new string[] {
            "악보 토막이다. 내 첫 악기는 피아노였지.\n지금은 어떻게 치는지 전부 까먹었지만 말이야",
            "그래도 악보 보는 법은 기억나는 것 같아.\n내 기억이 맞다면, 순서대로 솔, 미, 레, 시 일거야.",
            "근데 이게 숫자랑 관련이 있나?\n저 악보만으로는 풀 수 없는 문제같은데...",
            "어딘가에 또 다른 힌트가 있을지도 몰라. 방을 다시 돌아보자."
        };
    }
